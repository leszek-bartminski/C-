            ...
            do
            {
                ...
                else
                {
                    ...
                    else
                    {
                        ...
                        do
                        {
                            Console.WriteLine(language.Translation["wybierz_jedna_z_funkcji"]);
                            ...
                            {
                                Console.WriteLine(language.Translation["podaj_liczbe_od_1_do_4_Pozostale_znaki_są_niedozwolone"]);
                            }
                            else if (1 > functionId || functionId > 4)
                            {                               
                                Console.WriteLine(language.Translation["podałes_niewlasciwa_liczbe_Podaj_liczbe_z_zakresu_od_1_do_4"]);
                        ...
                        Console.WriteLine($"{language.Translation["wybrales_funkcje"]} {function.Name}");
                        ...
                        do
                        {
                            Console.WriteLine(language.Translation["wybierz_przedzial_calkowania_wciskajac_1_2_lub_3_na_klawiaturze"]);
                            ...
                            {
                                Console.WriteLine(language.Translation["podaj_liczbe_od_1_do_3_Pozostale_znaki_są_niedozwolone"]);
                            }
                            else if (1 > rangeId || rangeId > 3)
                            {
                                Console.WriteLine(language.Translation["podałes_niewlasciwa_liczbe_Podaj_liczbe_z_zakresu_od_1_do_3"]);
                        ...
                        List<Range> list = rangeList.CreateRangeList();
                        int i = 0;
                        ...
                        Console.WriteLine(language.Translation["jesli_chcesz_kontynuowac_wcisnij_y"]);
                        Console.WriteLine(language.Translation["jesli_chcesz_przerwac_wcisnij_kazdy_inny_klawisz"]);
